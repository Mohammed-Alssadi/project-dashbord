...
export function StoreSocialCard({ social }: StoreSocialCardProps) {
  const socialLinks = [
    ...
    { key: 'tiktok', name: 'تيك توك', value: social.tiktok, icon: TikTokIcon, color: 'text-black dark:text-white' },
...
function TikTokIcon(props: any) {
  return (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
      <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V9.01a6.35 6.35 0 0 0-.79-.05 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34V8.94a8.17 8.17 0 0 0 4.78 1.53V7.01a4.85 4.85 0 0 1-1.01-.32z"/>
    </svg>
  );
}
